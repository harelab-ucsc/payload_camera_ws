...
static const _AS7265xCal_type_support_symbol_names_t _AS7265xCal_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, as7265x_at_msgs, msg, AS7265xCal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, as7265x_at_msgs, msg, AS7265xCal)),
  }
};
...
{
  return &::as7265x_at_msgs::msg::rosidl_typesupport_cpp::AS7265xCal_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, as7265x_at_msgs, msg, AS7265xCal)() {
  return get_message_type_support_handle<as7265x_at_msgs::msg::AS7265xCal>();
}
