...
#include "as7265x_at_msgs/msg/detail/as7265x_raw__rosidl_typesupport_fastrtps_c.h"
...
using _AS7265xRaw__ros_msg_type = as7265x_at_msgs__msg__AS7265xRaw;
...
size_t get_serialized_size_as7265x_at_msgs__msg__AS7265xRaw(
  ...
  size_t current_alignment)
{
  const _AS7265xRaw__ros_msg_type * ros_message = static_cast<const _AS7265xRaw__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = as7265x_at_msgs__msg__AS7265xRaw;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const as7265x_at_msgs__msg__AS7265xRaw * ros_message = static_cast<const as7265x_at_msgs__msg__AS7265xRaw *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_as7265x_at_msgs__msg__AS7265xRaw(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  as7265x_at_msgs__msg__AS7265xRaw * ros_message = static_cast<as7265x_at_msgs__msg__AS7265xRaw *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_as7265x_at_msgs__msg__AS7265xRaw(cdr, ros_message);
}

static uint32_t _AS7265xRaw__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_as7265x_at_msgs__msg__AS7265xRaw(
...
static size_t _AS7265xRaw__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_as7265x_at_msgs__msg__AS7265xRaw(
...
static message_type_support_callbacks_t __callbacks_AS7265xRaw = {
  "as7265x_at_msgs::msg",
  "AS7265xRaw",
...
static rosidl_message_type_support_t _AS7265xRaw__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AS7265xRaw,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, as7265x_at_msgs, msg, AS7265xRaw)() {
  return &_AS7265xRaw__type_support;
}
